...
*/
var $_template = (s_selector,t_selector,data)=>{
  return new Promise((resolve,reject)=>{
    var ret = typeof data === "string" ? null : data;

    if(ret==null){
      $_http(data,"get","json",{},(server_data)=>{
        $_template(s_selector,t_selector,server_data).then(() => {
          resolve();
        });
      })
    }else{
...
template.helper('dateFormat',(date,format) => {
